...
namespace EmailSender
{
    public partial class FrmSteganography : Form
    {
        ...
        {
            toolStripStatusLabel1.Text ="Embedding... Please wait";
            ...
            toolStripStatusLabel1.Text = "Embedding  image has been successfully saved.";
            EncriptionDone = true;
        ...
        {
            toolStripStatusLabel1.Text = "Extracting... Please wait";
            Application.DoEvents();
            int i, j = 0;
            bool[] t = new bool[8];
            bool[] rb = new bool[8];
            ...
            toolStripStatusLabel1.Text = "Extracted file has been successfully saved.";
            Application.DoEvents();
        }
